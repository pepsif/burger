    ...
    return (
        <div>
            ...
            <div className="container">
                <h2 className="heading">{'Вхід в аккаунт'}</h2>
                <Divider />
